        ...
        <div className="min-h-screen bg-gradient-to-br from-green-400 to-blue-500 flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-white rounded-lg shadow-xl overflow-hidden">
                <div className="bg-[#243642] flex items-center justify-center m-0 p-0 text-white">
                    <img src={logo} className= "object-contain w-52" alt="Fit N Freak Logo" />
                </div>
                <h2 className="text-2xl font-bold text-center py-6 mb-6 text-gray-800">Join our community today!</h2>
                ...
                <div className='relative my-5'>
                    <p className="mt-4 text-center text-sm text-gray-600">
                        ...
                        <Link className="font-medium text-green-600 hover:text-green-500" to="/login" >
                        Log in
                        </Link>
                    </p>
                </div>
